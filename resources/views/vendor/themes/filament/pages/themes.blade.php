    ...
    <section class="">
        <header class="flex items-center gap-x-3 overflow-hidden py-4">
            <div class="grid flex-1 gap-y-1">
                <h3 class="fi-section-header-heading text-base font-semibold leading-6 text-zinc-950 dark:text-white">
                    {{ __('themes::themes.primary_color') }}
                </h3>

                <p class="fi-section-header-description text-sm text-zinc-500 dark:text-zinc-400">
        ...
        <div class="flex items-center gap-4 border-t py-6">
            ...
            @else
                <p class="text-zinc-700 dark:text-zinc-400">{{ __('themes::themes.no_changing_primary_color') }}
                </p>
            @endif
        </div>
    </section>
            ...
            @foreach ($this->getThemes() as $name => $theme)
                ...
                <x-filament::section>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            @if ($supportColorChange)
                                <span x-data="{}"
                                    ...
                                    <svg class="w-4 h-4 dark:text-zinc-800" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            @if ($noLightMode)
                                <h3 class="text-sm font-semibold text-zinc-600 pb-4">
                                    {{ __('themes::themes.no_light_mode') }}</h3>
                            @else
                                <h3 class="text-sm font-semibold text-zinc-600 pb-4">
                                    {{ __('themes::themes.light') }}</h3>
                                <img src="{{ url('https://raw.githubusercontent.com/Hasnayeen/themes/3.x/assets/' . $name . '-light.png') }}"
                                    ...
                                    class="border dark:border-zinc-700 rounded-lg">
                            @endif
                        </div>
                        ...
                        <div>
                            ...
                            @else
                                <h3 class="text-sm font-semibold text-zinc-600 pb-4">{{ __('themes::themes.dark') }}
                                </h3>
