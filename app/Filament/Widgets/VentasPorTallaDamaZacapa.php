...
class VentasPorTallaDamaZacapa extends ChartWidget
{
    use InteractsWithPageFilters;

    protected static ?string $pollingInterval = '10s';

    protected static ?string $heading = 'Ventas por Talla DAMA - Zacapa';
    ...
    protected function getData(): array
    {
        ...
        static::$heading = 'Ventas por Talla DAMA - Zacapa (Total: Q'.number_format($totalDinero, 2).')';
